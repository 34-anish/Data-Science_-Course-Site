...
import modules from "@/data/deerwalk/modules.json";
import resources from "@/data/deerwalk/resources.json";
      ...
      <section className="bg-gradient-to-br from-teal-900 to-teal-700 text-white">
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold md:text-6xl">
            Course Site for Advanced Python Programming
          </h1>

          <p className="mt-6 max-w-2xl text-lg text-blue-50">
            Non-credit course for grade 12, Deerwalk College
          </p>

          <div className="mt-8 flex gap-4">
            <Link
              href="/teaching/deerwalk/modules"
              className="rounded-lg bg-white px-5 py-3 font-medium text-blue-800"
            >
              Start Learning
            </Link>
            <Link
              href="/teaching/deerwalk/projects"
              className="rounded-lg bg-white px-5 py-3 font-medium text-blue-800"
            >
              Projects
            </Link>
            <Link
              href="/teaching/deerwalk/announcements"
              className="rounded-lg bg-white px-5 py-3 font-medium text-blue-800"
            >
              Announcements
            </Link>
            ...
            <Link
              href="/teaching/deerwalk/resources"
